...
// API Fetching Functions (assuming these are correct and unchanged)
...
export default function CourseDetailsPage({
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Automatically select the first class if it exists
  ...
  useEffect(() => {
    // This effect ensures a class remains selected after filtering
    if (
        ...
        <div className='md:col-span-1'>
          ...
          <div className='overflow-x-auto'>
            {filteredStudyClasses.length > 0 ? (
              ...
              // ✨ FIX: Added message for when no study classes are found
        ...
        <div className='md:col-span-2'>
          {selectedStudyClass ? (
            <div>
              ...
              {/* ✨ FIX: Better conditional rendering for students list */}
            ...
            // ✨ FIX: Correctly closed the conditional rendering block
            <div className='text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow'>
